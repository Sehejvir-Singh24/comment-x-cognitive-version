...
void main() {
  group('CaregiverDashboardScreen Tests', () {
    testWidgets('renders overview, cloud sync card, and recent activity', (tester) async {
      ...
      expect(find.text('Sync ID: test_uid_12345'), findsOneWidget);
      ...
      await tester.pumpAndSettle();
      expect(find.textContaining('Synced 2 item(s) to Firebase Firestore!'), findsOneWidget);
    });
  });
}
